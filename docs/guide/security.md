...
<!-- TODO: The features listed below are planned but not fully implemented. Update this section as they become available. The generator configuration options (`obfuscation`, `anti_av`, `anti_etw`) are placeholders for future development. -->
