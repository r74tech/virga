---
url: /virga/usage/mcp-integration.md
---
# MCP Integration
...
* **`shell`** - Direct shell command execution (alias for session\_command)
...
Query the in-memory database directly or through session\_command:
