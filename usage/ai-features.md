---
url: /virga/usage/ai-features.md
---
...
The default LLM model is **TinyLlama-1.1B-Chat-v1.0-GGUF** (Q4\_K\_M quantization, ~669MB). This model provides a good balance between size and performance for embedded AI operations.
...
|-------|------|----------|----------|
| **TinyLlama-1.1B Q4\_K\_M** | ~669MB | Default, balanced performance | [HuggingFace](https://huggingface.co/TheBloke/TinyLlama-1.1B-Chat-v1.0-GGUF) |
| **TinyLlama-1.1B Q8\_0** | ~1.2GB | Higher quality responses | [HuggingFace](https://huggingface.co/TheBloke/TinyLlama-1.1B-Chat-v1.0-GGUF) |
| **Vicuna-7B Q4\_K\_M** | ~3.8GB | Better chat capabilities | [HuggingFace](https://huggingface.co/TheBloke/vicuna-7B-v1.5-GGUF) |
| **WizardLM-7B Q4\_K\_M** | ~3.8GB | Better instruction following | [HuggingFace](https://huggingface.co/TheBloke/WizardLM-7B-GGUF) |
